...
double inPolygon(double x,double y)
{
    double S1 = S(x,y,a[2].x,a[2].y,a[3].x,a[3].y);
    double S2 = S(a[1].x,a[1].y,x,y,a[3].x,a[3].y);
    double S3 = S(a[1].x,a[1].y,a[2].x,a[2].y,x,y);
    double S4 = S(a[1].x,a[1].y,a[2].x,a[2].y,a[3].x,a[3].y);
    if (abs(S1 + S2 + S3 - S4) <= 0.000001) return true; else return false;
}
...
int main()
{
    //freopen("E506.inp","r",stdin);
    //freopen("E506.out","w",stdout);
    for (int i = 1; i <= 4; i++)
    {
    ...
    y/=4;
    z/=4;
    if (OnLine(Point(x,y),Point(a[1].x,a[1].y),Point(a[2].x,a[2].y)))
    {
            cout<<"Unstable";
            return 0;
    }
    if (OnLine(Point(x,y),Point(a[2].x,a[2].y),Point(a[3].x,a[3].y)))
    {
            cout<<"Unstable";
            return 0;
    }
    if (OnLine(Point(x,y),Point(a[3].x,a[3].y),Point(a[1].x,a[1].y)))
    {
            cout<<"Unstable";
            return 0;
    }
